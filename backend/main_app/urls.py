...
urlpatterns = [
    ...
    path("course/add", hod_views.add_department, name='add_department'),
    ...
    path("subject/add/", hod_views.add_course, name='add_course'),
    path("staff/manage/", hod_views.manage_staff, name='manage_staff'),
    path("student/manage/", hod_views.manage_student, name='manage_student'),
    path("course/manage/", hod_views.manage_dep, name='manage_dep'),
    path("subject/manage/", hod_views.manage_course, name='manage_course'),
    ...
    path("course/edit/<int:dep_id>",
         hod_views.edit_dep, name='edit_dep'),
    ...
    path('staff/assignments', staff_views.assignments,
         name='assignments'),
    path('staff/assignment/upload_assignment/', staff_views.upload_assignment, 
         name='upload_assignment'),
    path('staff/submissions/<int:ass_pk>', staff_views.staff_submissions, 
          name='staff_submissions'),
    path('staff/submissions/<int:pk>/grade/', staff_views.grade_assignment,
          name='grade_assignment'),
    path('staff/course_materials/', staff_views.course_materials, 
          name='course_materials'),
    path('staff/course_materials/<int:pk>', staff_views.view_materials, 
          name='view_materials'),
    path('staff/course_materials/upload', staff_views.upload_material, 
          name='upload_material'),

     path("course_material/<int:pk>",
         hod_views.edit_subject, name='download_material'),
    ...
    path('student/assignments/submission/<int:pk>', student_views.view_submission, 
          name='view_submission'),
    path('student/assignment/submit_assignment', student_views.submit_assignment, 
          name='submit_assignment'),
    path('student/course_materials', student_views.course_materials, 
